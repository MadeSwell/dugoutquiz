export const secondBaseman1 = {
  quizTitle: "Second Baseman Scenarios",
  quizSynopsis: "Train your brain so when you get the ball you know what to do!",
  questions: [
    {
      question: "Ground ball to pitcher. What do you do?? ",
      questionType: "text",
      answers: ["Backup 1st base", "Move towards the ball and backup the pitcher", "Cover 2nd base", "Stay put"],
    ...
    },
    {
      ...
      answers: [
        ...
        "Toss it to 1st base",
        "Backhand (for a righty) the ball and make a hard throw to 1st base",
        "Let SS get it"
      ],
      questionType: "text",
      answerSelectionType: "single",
    ...
    {
      question: "You field a ground ball close to 1st base. What do you do?",
      answers: [
    ...
    },
    {
      ...
      questionType: "text",
      answers: ["Flip to the SS covering 2nd base", "Throw to 3rd base", "Hold it"],
      answerSelectionType: "single",
      point: 50,
      showField: true,
      field: {
